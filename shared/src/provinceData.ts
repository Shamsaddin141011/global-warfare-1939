...
export const PROVINCES: ProvinceSeed[] = [
  ...
  { id: 'bordeaux',   name: 'Bordeaux',   parent: 'france', centroid: [-0.6, 44.8], terrain: 'plains', isCoastal: true,  garrison: 5,  fortLevel: 1, supplyLevel: 1.0, industryOutput: 7,  manpowerOutput: 100, resourceOutput: { food: 5 }, adjacentTo: ['france', 'spain'] },
